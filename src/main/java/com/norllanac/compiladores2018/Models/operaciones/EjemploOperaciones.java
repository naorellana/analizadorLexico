 ...
 */
package com.norllanac.compiladores2018.Models.operaciones;
            ...
            switch (valor) {
                ...
                case GENERAR: {
                    ...
                    if (args.length > 0) {
                        ...
                        archLexico = "operaciones.flex"; //el archivo esta en la carpeta razi de este proyecto
                ...
                case EJECUTAR: {
                     ...
                     */
                    String[] archivoPrueba = {"operaciones.txt"}; //el archivo esta en la carpeta razi de este proyecto y puede editarse
